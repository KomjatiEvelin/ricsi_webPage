<div class="card text-center m-2 align-middle" style="color: black; background-color:rgba(202, 209, 219, 0.5); align-self:center;">
        <div class="card-body">
            ...
            <form class="card p-2 m-3 rounded" method="post" enctype="multipart/form-data" action="login/modifypwd">
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-dark" style="font-size:1.8vh;">Módosít</button>
            </form>
        </div>
</div>
