<div class="content d-flex flex-wrap p-3 mt-4 mb-2 mr-3 rounded justify-content-center" style="min-height:90%; width:95%; color:white; background-color:rgba(0, 0, 0, 0.5);">
    ...
    <h5 style="font-weight:bold;">A nevem Dumity Richárd</h5> 
    <p>1997-ben születtem majd 3 évre rá egy baleset következtében deréktól lefelé lebénultam,
        azóta kerekesszékben élem mindennapjaimat.</p>
        <p>A testmozgás mindig az életem szerves része
        volt. A Merjünk Sérülten Mozogni Egyesület (melynek elnöke nagymamám,
    ...
    <p>A 2020-as évben lehetőséget kaptam arra, hogy egy
        nagy álom kézzelfogható távolságba kerüljön. Fábián Attila a Magyar Síszövetség és a
        Magyar Paralimpiai Bizottság szakágvezetője és Klausmann Viktor, a Magyar Síakadémia
        elnöke segítségével lehetőségem nyílt arra, hogy a magyar mezőnyben klasszifikáljanak és
        ezzel a 2026-os téli Paralimpián való részvétel lehetővé válhasson. </p>
    <p>Napi szinten fejlesztés
