 ...
 <div class="homecontent p-3 mt-2 mb-2 mr-3 rounded" style="min-height:90%; width:100%; color:black; background-color:rgba(202, 209, 219, 0.5);">
     ...
     <br>
     <img id="first-img" src="<?= base_url(); ?>/images/first.jpg" alt="kezdőkép Dumity Richárd" style="padding:5px; padding-right:10px; width:300px; float:left;"/>
     ...
     <h5>
        ...
        <br/><br/>Jelenleg mezőgazdasági mérnök szakon vagyok egyetemista, már csak az államvizsga van hátra, emellett nemzetközileg elismert középfokú
        nyelvvizsgával is rendelkezem. Több félévet évfolyam elsőként fejeztem be, amely nagymértékben segítette a sportolásom is, mivel az ösztöndíjjal is lehetőségem volt saját magam szponzorálására.
